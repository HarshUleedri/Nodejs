-For using ES6 import and export we should have latest nodejs. after one more things is -Important which we have to write "type": "module" in the package.json file.
